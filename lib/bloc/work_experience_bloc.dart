...
class WorkExperienceBloc extends Bloc<WorkExperienceEvent, WorkExperienceState> {
  ...
  WorkExperienceBloc({required MyRepository myRepository}) :_myRepository= myRepository, super(WorkExperienceLoading());

  @override
  Stream<WorkExperienceState> mapEventToState(WorkExperienceEvent event,)async* {
  ...
  Stream<WorkExperienceState>_mapLoadWorkExperienceToState() async* {
    ...
    _subscription = _myRepository.getAllWorkExperience().listen((works) {UpdateLoadWorkExperience(works);});

  }

  Stream<WorkExperienceState>_mapUpdateWorkExperienceToState(UpdateLoadWorkExperience event)async* {
